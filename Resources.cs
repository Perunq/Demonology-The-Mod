...
namespace Demonology
{
    class Resources
    {
        ...
        {
            BlueprintGuid? assetId = Config.ModSettings.Blueprints.GetGUID(name);
        ...
        {
            var assetId = Config.ModSettings.Blueprints.GetGUID(name);
        ...
        internal static string GetParamString(string parameters, int v1, string v2)
        {
