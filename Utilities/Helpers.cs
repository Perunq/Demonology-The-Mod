...
namespace Demonology.Utilities
{
    public static class Helpers
    {
        ...
        public static AddAbilityResources CreateAddAbilityResource(this BlueprintAbilityResourceReference resource)
        {
            var a = Create<AddAbilityResources>();
            a.m_Resource = resource;
